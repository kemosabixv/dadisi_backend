    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-auth-password-email">POST api/auth/password/email</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-auth-password-reset">
                                <a href="#authentication-POSTapi-auth-password-reset">POST api/auth/password/reset</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The user's full name. Example: <code>Curl User</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-password-email">POST api/auth/password/email</h2>
...
<p>Must be a valid email address. Example: <code>gbailey@example.net</code></p>
                    ...
                    <h2 id="authentication-POSTapi-auth-password-reset">POST api/auth/password/reset</h2>
