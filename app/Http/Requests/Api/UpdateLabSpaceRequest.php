 ...
 * @bodyParam type string optional in:wet_lab,dry_lab,greenhouse,mobile_lab,makerspace,workshop,studio,other
...
class UpdateLabSpaceRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'type' => ['sometimes', Rule::in(['wet_lab', 'dry_lab', 'greenhouse', 'mobile_lab', 'makerspace', 'workshop', 'studio', 'other'])],
    ...
    public function bodyParameters()
    {
        return [
            ...
            'hourly_rate' => ['description' => 'Hourly rate for booking (KES)', 'example' => 1200.00],
